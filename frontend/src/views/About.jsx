    ...
    <div className="view">
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(220px, 1fr))', gap:10, marginBottom:16 }}>
        {[
          ...
          { icon:'📋', title:'Sales Orders', desc:'Full order lifecycle: Enquiry → Quotation → SO → DC → Delivery challan → POD capture → Payment tracking (UNPAID/PARTIAL/PAID) → Return processing. AI delay detection and email notifications.', color:'#6366f1' },
          ...
          { icon:'🛡️', title:'Damage Recording',    desc:'Record GRN, transit, and sales-return damage with condition split (Good/Partial/Full), insurance claim workflow, automatic accounting entries, and SKU-level recovery tracking.', color:'#ef4444' },
